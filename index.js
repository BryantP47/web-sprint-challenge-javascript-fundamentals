...
const zooAnimals = [
  ...
  */
    ...
    function animalNames(){
     const zooAnimals = data.forEach(function(item){
...
// console.log(animalNames);
  ...
  function lowerCaseNames(){
    const lowerCaseAni =  zooAnimals.map(function(element){
...
// console.log(lowerCaseAni);
  ...
  */
  ...
  function USApop(acc, item){
    const popCB = zooAnimals.reduce(function(acc, item){
